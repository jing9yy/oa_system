...
public interface TransferMapper {
    ...
    @Select("SELECT transfer_id as transferId,employee_id as employeeId,transfer_to_position as transferToPosition,approver_id as approverId,is_approved as isApproved,transfer_to_department_id as transferToDepartmentId from oa_system.transfer where employee_id = #{employeeId}  ")
    ...
    @Select("SELECT transfer_id as transferId,employee_id as employeeId,transfer_to_position as transferToPosition,approver_id as approverId,is_approved as isApproved,transfer_to_department_id as transferToDepartmentId from oa_system.transfer where oa_system.transfer.is_approved = 0")
    ...
    @Select("SELECT transfer_id as transferId,employee_id as employeeId,transfer_to_position as transferToPosition,approver_id as approverId,is_approved as isApproved,transfer_to_department_id as transferToDepartmentId FROM oa_system.transfer WHERE transfer_id = #{transferId}")
